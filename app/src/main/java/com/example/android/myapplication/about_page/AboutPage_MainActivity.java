package com.example.android.myapplication.about_page;
...
public class AboutPage_MainActivity extends Fragment {
    @Nullable
    @Override
    ...
    Element getCopyRightsElement() {
        ...
        copyRightsElement.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                makeText(getContext(), copyrights, LENGTH_SHORT).show();
            }
        });
